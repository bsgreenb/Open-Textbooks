...
--
-- Host: localhost
-- Generation Time: Feb 10, 2012 at 01:26 PM
...
CREATE TABLE `Bookstores` (
  ...
  `Multiple_Campuses` enum('Y','N') DEFAULT NULL COMMENT 'Some schools have a campus dropdown',
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=46378 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=114962 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=157558 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='Items includes, but is not limited to isbn-having books.' AUTO_INCREMENT=33755 ;
