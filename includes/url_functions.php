...
function curl_request($options) //single custom cURL request.
{
	...
	$options[CURLOPT_COOKIEJAR] = $_SERVER['DOCUMENT_ROOT'] .'/../tmp/'. $user_token .'_cookies.txt';  //going to look into the effects of this..
	$options[CURLOPT_COOKIEFILE] = $_SERVER['DOCUMENT_ROOT'] .'/../tmp/'. $user_token .'_cookies.txt';
